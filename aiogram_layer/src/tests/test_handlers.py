...
from aiogram_layer.src.tests.fixtures import get_message, get_update, get_callback_query
...
@pytest.mark.asyncio
@pytest.mark.parametrize('command, state, answer, markup', [(Text(cb.about.value), None, ABOUT_MESSAGE, main_menu)])
...
@pytest.mark.asyncio
@pytest.mark.parametrize('command, state, answer, markup', [(Text(cb.city.value), None, ENTER_CITY, to_main_menu)])
